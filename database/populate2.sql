...
INSERT INTO "Auction" (user_id, category_id, starting_price, reserve_price, current_price, minimum_bid_increment, description, starting_date, ending_date, title, location, status) VALUES
                                                                                                                                                                                      (2, 1, 100.00, 500.00, 150.00, 10.00, 'Latest smartphone model.', NOW() - INTERVAL '3 days', NOW() + INTERVAL '2 days' - Interval '2 hours' - Interval '42 minutes', 'Golden IPhone Auction', 'New York, NY', 'Active'),
                                                                                                                                                                                      ...
                                                                                                                                                                                      (1,6, 100.00, 500.00, 150.00, 10.00, 'Latest smartphone model.', NOW() - INTERVAL '1 hour', NOW() + INTERVAL '2 hours', 'Smartphone Auction', 'New York, NY', 'Active'),
